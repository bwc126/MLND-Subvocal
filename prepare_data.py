...
class data_preparer():
    ...
    def sv_detection(self):
        ...
        no_sv = data_1[:3000].append([data_2[:2000],data_3[:2000],data_4[:2000],data_5[:2000]],ignore_index=True)
        # Now select a few portions that most likely do contain some specific SV.
        with_sv = data_1[5000:9000].append([data_2[6000:10000],data_3[3000:9000]],ignore_index=True)
